...
def _test_prepare_without_interaction(monkeypatch, api_method, provide_mode):
    ...
    p = api.AnacondaProject()
    kwargs = dict(project=43, environ=57, command_name='foo', extra_command_args=['1', '2'])
...
def test_prepare_project_browser(monkeypatch):
    ...
    p = api.AnacondaProject()
    kwargs = dict(project=43, environ=57, command_name='foo', extra_command_args=['1', '2'], io_loop=156, show_url=8909)
