...
def test_add_download_fails_to_get_status(capsys, monkeypatch):
    def check(dirname):
        _monkeypatch_pwd(monkeypatch, dirname)
        _monkeypatch_add_download(monkeypatch, None)
        ...
        assert 'Unable to add download http://localhost:123456\n' == err
